...
const editClick = (clickInfo:EventClickArg)=>{
    ...
    editRef.value.editCalender(EditType.REMOVE, clickInfo.event.extendedProps);
}
//上周
...
const calendarOptions = reactive({
  ...
  eventMouseEnter: function(info){
    ...
    tippy(info.el,{
      ...
      "<div style='color: #666666'>实训项目: " + info.event.extendedProps.courseName + "</div>" +
      "<div style='color: #666666'>实验室: " + info.event.extendedProps.roomName +  "</div>" +
      "<div style='color: #666666'>课时总数: " + "共" + info.event.extendedProps.sequenceTotal + "节" + "</div>" +
      "<div style='color: #666666'>班级: " +  info.event.extendedProps.className + "</div>" +
      "<div style='color: #666666'>人数: " +  info.event.extendedProps.classNumber + "</div>" +
      "<div style='color: #666666'>老师: " +  info.event.extendedProps.teacherName + "</div>" +
      "<div style='color: #666666'>电子锁密码: " +  info.event.extendedProps.password + "</div>" +
      "</div>",
      theme: 'light',
      interactive: true,
      allowHTML: true,
